...
cdef class CpuParams:
    ...
    @staticmethod
    cdef CpuParams from_ptr(app_params *p):
        cdef CpuParams wrapper = CpuParams.__new__(CpuParams)
        wrapper.ptr = &(p.cpuparams)
        return wrapper
...
cdef class AppParams:
    ...
    cdef AppParams from_instance(app_params p):
        ...
        wrapper.params = p
        wrapper.cpuparams = CpuParams.from_ptr(&wrapper.params)
        return wrapper
    ...
    def __cinit__(self):
        ...
        _ap.cpuparams = _cp
        self.params = _ap
        self.cpuparams = CpuParams.from_ptr(&self.params)
